...
public class Notepad extends JFrame implements ActionListener {
    ...
    private final static Map<String, Color> AVAILABLE_COLORS = Map.of(
            "Blue", Color.blue,
            "Yellow", Color.yellow,
            "Orange", Color.orange,
            "Red", Color.red,
    ...
    public Notepad(String str) {
        ...
        for (Map.Entry<String, Color> entry : AVAILABLE_COLORS.entrySet()) {
            ...
            colorFore.addActionListener(e -> text.setForeground(entry.getValue()));

            JMenuItem colorBack = new JMenuItem(entry.getKey());
            colorBack.addActionListener(this);
            colorBack.addActionListener(e -> text.setBackground(entry.getValue()));
